...
What other generalizations can we make? Well, perhaps the most important one is that only generators which are co-prime with 12 will generate the entire chromatic scale or aggregate. There are only four such generators: $<1>$ and its inversion partner $<11>\\,$ $<5>$ and its inversion partner $<7>$.
...
| --- | ---| --- | --- |
| $<1>$ | $gcd(1,12)=1$ | $12/1=12$ | Chromatic |
| $<2>$ | $gcd(2,12)=2$ | $12/2=6$ | Wholetone |
| $<3>$ | $gcd(3,12)=3$ | $12/3=4$ | Diminished 7th |
| $<4>$ | $gcd(4,12)=4$ | $12/3=3$ | Augmented triad |
| $<5>$ | $gcd(5,12)=1$ | $12/1=12$ | Chromatic |
| $<6>$ | $gcd(6,12)=6$ | $12/6=2$ | Tritone |
| $<7>$ | $gcd(7,12)=1$ | $12/1=12$ | Chromatic |
| $<8>$ | $gcd(8,12)=4$ | $12/4=3$ | Augmented triad |
| $<9>$ | $gcd(9,12)=3$ | $12/3=4$ | Diminished 7th |
| $<10>$ | $gcd(10,12)=2$ | $12/2=6$ | Wholetone |
| $<11>$ | $gcd(11,12)=1$ | $12/1=12$ | Chromatic |
...
| --- | --- | --- |
| 5 | $<5-5-5-5>$ | Pentatonic |
| 6 | $<5-5-5-5-5>$ | Hexatonic |
| 7 | $<5-5-5-5-5-5>$ | Diatonic |
| 8 | $<5-5-5-5-5-5-5>$ | Bebop |
